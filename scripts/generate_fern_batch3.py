"""Generate 3 ferns based on Confirmed_03 (bushy oval) with left-leaning curves.
1. Slightly left
2. More left
3. Different left angle
Confirmed files NOT touched."""
import random
import numpy as np
...
# Base = Confirmed_03 coefficients, adding curvature via T2 b/c
VARIANTS = [
    {
        "name": "T_Fern_Atlas_02",
        "desc": "Oval, slight lean right (same as Atlas_02 left but mirrored)",
        "seed": 401,
        "transforms": [
            (0.0,   0.0,   0.0,   0.20,  0.0,  -0.12, 0.01),
            (0.90,  0.02, -0.02,  0.88,  0.0,   0.7,  0.80),
    ...
    },
    {
        ...
        "desc": "Oval, very slight lean right (half of above)",
        "seed": 402,
        "transforms": [
            (0.0,   0.0,   0.0,   0.20,  0.0,  -0.12, 0.01),
    ...
    },
    {
        ...
        "desc": "Oval, moderate lean right (between the two)",
        "seed": 403,
        "transforms": [
            (0.0,   0.0,   0.0,   0.20,  0.0,  -0.12, 0.01),
            (0.90,  0.015,-0.015, 0.88,  0.0,   0.7,  0.80),
            (0.05, -0.16,  0.26,  0.05, -0.07,  0.02, 0.095),
            (-0.05, 0.16,  0.26,  0.05,  0.07,  0.12, 0.095),
        ],
    },
...
print("\nDone! Confirmed files NOT touched.")
