...
FGetFontMetadataCommand::FGetFontMetadataCommand(TSharedPtr<IProjectService> InProjectService)
    : ProjectService(InProjectService)
{
}

bool FGetFontMetadataCommand::ValidateParams(const FString& Parameters) const
{
...
FString FGetFontMetadataCommand::Execute(const FString& Parameters)
{
    ...
    FString Error;
    TSharedPtr<FJsonObject> Metadata = ProjectService->GetFontMetadata(FontPath, Error);
