...
class UNREALMCP_API FAddBlueprintEventNodeCommand : public IUnrealMCPCommand
{
public:
    explicit FAddBlueprintEventNodeCommand(IBlueprintNodeService& InBlueprintNodeService);
