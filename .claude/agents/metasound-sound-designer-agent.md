...
Follow the loaded skill instructions. Optimization-first (CPU budgets, voice limits, distance culling). Use metasoundMCP tools via ToolSearch when available.
